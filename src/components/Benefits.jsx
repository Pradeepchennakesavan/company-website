...
const Benefits = () => {
  return (
    <div className='flex flex-col sm:flex-row mt-16 mb-[71px]  gap-12 '>

      <div>
        <img className='w-full sm:w-full overflow-x-hidden object-contain h-full' src={deliver} alt="" />
      </div>
      ...
      <div className='flex flex-col justify-end pb-5 gap-1 border-b-2 w-full '>
          ...
          <p className='poppins-semibold pb-3 text-2xl md:text-3xl sm:text-xl text-[#1A0076]'>We created XXXX to deliver you :</p>
